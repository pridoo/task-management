...
<body class="overflow-x-hidden bg-gray-100">
    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-orange-500 p-4 z-50 sidebar-menu transition-transform">
        ...
        <ul class="mt-4">
            ...
            <li class="mb-1 group">
                <a href="#"
                    class="flex items-center py-2 px-4 text-gray-300 hover:bg-orange-700 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-orange-700 group-[.selected]:text-gray-100 sidebar-dropdown-toggle">
                    <img src="{{ asset('css/pictures/Users.png') }}" alt="Tasks" class="w-8 h-8 rounded ">
                ...
                <ul class="pl-7 mt-2 hidden group-[.selected]:block">
                    <li class="mb-2">
                        <a href="#" class="flex items-center py-2 px-4 text-gray-300">
                            <img src="{{ asset('css/pictures/Active.png') }}" alt="All Tasks" class="w-7 h-7 rounded ">
                            <span class="text-sm font-small text-white ml-3">Active</span>
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="#" class="flex items-center py-2 px-4 text-gray-300">
                            <img src="{{ asset('css/pictures/Pending.png') }}" alt="Completed" class="w-7 h-7 rounded ">
                            <span class="text-sm font-small text-white ml-3">Pending</span>
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="#" class="flex items-center py-2 px-4 text-gray-300">
                            <img src="{{ asset('css/pictures/Approved.png') }}" alt="To do" class="w-7 h-7 rounded ">
                            <span class="text-sm font-small text-white ml-3">Approved</span>
                        </a>
                    </li>
                </ul>
            </li>
