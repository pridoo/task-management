        ...
        <main class="pt-24 px-6 ml-64">
            ...
            <div x-data="{ tab: 'details' }" class="mx-auto max-w-[90%] md:max-w-[1050px]">
                ...
                <div x-show="tab === 'details'" x-cloak>
                    ...
                    <div class="mx-auto max-w-[90%] md:max-w-[1050px] p-6 bg-white border border-[#4444] rounded-lg">
                        ...
                        <div class="flex justify-between items-center">
                            <!-- Status -->
                            <button class="mb-4 px-6 py-2 text-white text-xs rounded-lg
                        ...
                        <div class="flex flex-wrap items-center gap-x-8 text-sm text-[#444] mb-4">
                            <div class="flex gap-1 font-semibold">
                                ...
                                <span class="font-light">{{ \Carbon\Carbon::parse($task->start_date)->format('l, F j, Y h:i A') }}</span>
                            </div>
                            <div class="flex gap-1 font-semibold">
                                <span>End Date:</span>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4 mb-6">
                            @php
                                // Decode attachment if it's a JSON string
                            ...
                            @forelse ($attachments as $file)
                                @php
                                    ...
                                    $size = round(Storage::size($file) / 1024 / 1024, 1) . ' MB';
                        ...
                        <!-- Assignees -->
                        <div class="mt-6">
                            <span class="text-[#444] text-[12px] font-semibold">Assigned to:</span>

                            <div class="mt-2 flex flex-col space-y-2">
                                @forelse ($task->users as $user)
                                    <div class="flex items-center space-x-2">
                                        <div class="w-6 h-6 rounded-full bg-gray-300 flex items-center justify-center text-xs text-gray-700">
                ...
                <div x-show="tab === 'comments'" x-cloak>
                    @include('user.tasks.comments', ['task' => $task])
                </div>
            </div>
        </main>
    </div>
