...
<div class="min-h-screen bg-gray-100"
    ...
    <main class="pt-24 px-6 ml-64">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-semibold text-gray-800">To Do Tasks</h2>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            @forelse ($tasks as $task)
                <div class="bg-white shadow rounded-lg p-4 border relative">
                    ...
                    <div class="text-xs text-gray-500 mb-2">📅 {{ \Carbon\Carbon::parse($task->start_date)->format('D, d M h:i A') }}</div>
            ...
            @empty
                <div class="col-span-3 text-center text-gray-500 text-sm">
                    No "To do" tasks assigned to you.
                </div>
            @endforelse
        </div>
    </main>
