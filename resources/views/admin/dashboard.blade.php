                                ...
                                <tr class="hover:bg-gray-50 transition-all">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="relative w-[127px] h-4">
                                            <div class="absolute left-0 top-0 w-[11px] h-[10px] bg-red-500 rounded-full">
                                            </div>
                                            <span
                                ...
                                <tr class="hover:bg-gray-50 transition-all">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="relative w-[127px] h-4">
                                            ...
                                            <span
                                                class="absolute left-4 top-0 w-[110px] h-4 text-[12px] leading-[15px] font-light text-[#444444]">In progress</span>
                                        </div>
                                    </td>
                                    <td class="px-4 py-3 text-sm text-gray-700">Fri, 03 Jan 7:00 AM</td>
                                    <td class="px-4 py-3 italic text-gray-500">Late</td>
