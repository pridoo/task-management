...
@section('content')
    ...
    <body class="text-gray-800 font-inter">
        <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-50 min-h-screen transition-all main overflow-y-auto">
            <div class="py-2 pr-6 pl-2 bg-white flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-30">

                <ul class="flex items-center text-sm ml-4">
                    <li class="mr-2">
                        <a href="#" class="text-gray-400 hover:text-gray-600 font-medium">Super Admin Dashboard</a>
                    </li>
                </ul>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                    <div class="bg-blue-500 rounded-md border border-gray-100 p-6 shadow-md">
                        <div class="flex justify-between mb-6">
                            ...
                            <div class="dropdown">
                                <button class="dropdown-toggle text-white hover:text-gray-200"><i
                                        class="ri-more-fill"></i></button>
                                <ul
                                    class="dropdown-menu hidden py-1.5 rounded-md bg-white border border-gray-100 max-w-[140px]">
                                    <li><a href="{{ url('admin/tasks/all-tasks') }}"
                    ...
                    <div class="bg-green-500 rounded-md border border-gray-100 p-6 shadow-md">
                        <div class="flex justify-between mb-6">
                            ...
                            <div class="dropdown">
                                ...
                                <ul
                                    class="dropdown-menu hidden py-1.5 rounded-md bg-white border border-gray-100 max-w-[140px]">
                                    <li><a href="{{ url('admin/tasks/completed') }}"
                                            class="flex items-center text-[13px] py-1.5 px-4 text-gray-600 hover:text-green-500 hover:bg-gray-50">View
                                            Details</a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="bg-yellow-500 rounded-md border border-gray-100 p-6 shadow-md">
                        <div class="flex justify-between mb-6">
                            ...
                            <div class="dropdown">
                                ...
                                <ul
                                    class="dropdown-menu hidden py-1.5 rounded-md bg-white border border-gray-100 max-w-[140px]">
                                    <li><a href="{{ url('admin/tasks/in-progress') }}"
                                            class="flex items-center text-[13px] py-1.5 px-4 text-gray-600 hover:text-yellow-500 hover:bg-gray-50">View
                                            Details</a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="bg-red-500 rounded-md border border-gray-100 p-6 shadow-md">
                        <div class="flex justify-between mb-6">
                            ...
                            <div class="dropdown">
                                ...
                                <ul
                                    class="dropdown-menu hidden py-1.5 rounded-md bg-white border border-gray-100 max-w-[140px]">
                                    <li><a href="{{ url('admin/tasks/to-do') }}"
                                            class="flex items-center text-[13px] py-1.5 px-4 text-gray-600 hover:text-red-500 hover:bg-gray-50">View
                                            Details</a></li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="{{ url('admin/tasks/all-tasks') }}" class="text-sm text-blue-500 hover:underline">View
                            All</a>
                    </div>
                            ...
                            <tbody class="divide-y divide-gray-100">
                                @foreach ($allTasks as $task)
                                    <tr class="hover:bg-gray-50 transition-all">
                                        ...
                                        <td class="px-4 py-3">
                                            <span class="text-xs font-medium text-yellow-500">{{ ucfirst($task->priority) }}
                                                Priority</span>
                                        </td>
                                        <td class="px-4 py-3">
                                            <div class="relative w-[127px] h-4">
                                                <div
                                                    class="absolute left-0 top-0 w-[11px] h-[10px] {{ $task->status_class }} rounded-full">
                                                </div>
                                                <span
