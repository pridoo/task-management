...
@section('content')
    ...
    <body class="text-gray-800 font-inter">
        ...
        <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-50 min-h-screen transition-all main overflow-y-auto">
            <div class="p-4">
                <div
                    class="py-2 px-6 bg-white flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-30 rounded-md border border-gray-200">
                        ...
                        <table class="w-full text-sm text-left text-gray-700">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                ...
                                <tr class="hover:bg-gray-50 transition-all">
                                    ...
                                    <td class="px-4 py-3">
                                        <span class="px-2 py-1 rounded-full text-xs font-medium bg-red-500 text-white">To
                                            do</span>
                                    </td>
                                ...
                                <tr class="hover:bg-gray-50 transition-all">
                                    ...
                                    <td class="px-4 py-3">
                                        <span class="px-2 py-1 rounded-full text-xs font-medium bg-yellow-400 text-white">In
                                            progress</span>
                                    </td>
                                    <td class="px-4 py-3 text-sm text-gray-700">Fri, 03 Jan 7:00 AM</td>
                                    <td class="px-4 py-3 italic text-gray-500">Late</td>
