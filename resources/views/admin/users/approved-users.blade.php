...
@section('content')
    ...
    <div class="min-h-screen bg-gray-100" x-data="userManager()" x-init="init()">
                            ...
                            @foreach($approvedUsers as $user)
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="bg-green-100 text-green-800 text-xs font-semibold px-2 py-1 rounded-full">Active</span>
                                    </td>
                                    <td class="px-6 py-4 text-center space-x-2">
                                        <form method="POST"
                                            action="{{ route('admin.unapprove-user', ['userId' => $user->id]) }}"
                                            class="inline">
                                            @csrf
        ...
        <div x-show="editOpen" x-cloak x-transition.opacity
            ...
            <div @click.outside="editOpen = false" class="bg-white w-full max-w-lg p-6 rounded-xl shadow-xl border">
