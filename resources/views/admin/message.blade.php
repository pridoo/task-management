                        ...
                        <div class="flex items-center">
                            <div class="relative flex items-center px-0.5 space-x-0.5">
                                ...
                                <div x-show="filterMessages" @click.away="filterMessages = false"
                                    ...
                                    style="display: none;">
                                    <button @click="filterMessages = false"
                                        class="w-full text-sm py-1 hover:bg-blue-600 hover:bg-opacity-30">
                                        All
                                    </button>
                                    <button @click="filterMessages = false"
                                        class="w-full text-sm py-1 hover:bg-blue-600 hover:bg-opacity-30">
                            ...
                            <li class="flex items-center border-y hover:bg-gray-200 px-2">
                                ...
                                <div x-data="{ messageHover: false }" @mouseover="messageHover = true"
                                    ...
                                    <div class="flex items-center">
                                        <div class="flex items-center mr-4 ml-1 space-x-1">
                                            <button title="Not starred">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="text-gray-500 hover:text-gray-900 h-5 w-5" fill="none"
                                                    viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                        d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z">
                                                    </path>
                                        ...
                                        <span class="w-96 text-gray-600 text-sm truncate">Sed ut perspiciatis unde omnis
                                            iste natus error sit voluptatem</span>
                                    </div>
                            ...
                            <li class="flex items-center border-y hover:bg-gray-200 px-2">
                                ...
                                <div x-data="{ messageHover: false }" @mouseover="messageHover = true"
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span class="mx-1">-</span>
                                        <span class="w-96 text-gray-600 text-sm truncate">Vel illum qui dolorem eum
                                            fugiat quo voluptas nulla pariatur?</span>
                                    </div>
                                    <div class="w-32 flex items-center justify-end">
                                        <div x-show="messageHover" class="flex items-center space-x-2"
                                            style="display: none;">
