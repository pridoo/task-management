                ...
                @foreach ($tasks as $task)
                    <div class="bg-white shadow rounded-lg p-4 border relative">
                        ...
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <span
                                class="text-xs font-semibold text-{{ $task->priority == 'High' ? 'red' : ($task->priority == 'Medium' ? 'yellow' : 'green') }}-500">{{ ucfirst($task->priority) }}
                                Priority</span>
                        </div>
                        ...
                        <div class="mt-6 flex justify-between items-center">
                            <div class="flex space-x-2 items-center">
                                ...
                                @if ($task->users->count())
                                    ...
                                    @endforeach
                                @else
                                    <span class="text-xs text-gray-400 ml-2">No users assigned</span>
                                @endif
                            </div>
                        </div>
