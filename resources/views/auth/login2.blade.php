                    ...
                    <h1 class="flex items-center text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl md:text-5xl lg:text-6xl">
                        <span class="text-orange-700 mr-3">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 64 64"
                                ...
                                <path d="M2 32c7 0 7-12 14-12s7 12 14 12 7-12 14-12 7 12 14 12"
                                      stroke="currentColor" stroke-width="5" fill="none"
                                      stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M2 40c7 0 7 12 14 12s7-12 14-12 7 12 14 12 7-12 14-12"
                                      stroke="currentColor" stroke-width="5" fill="none"
                                      stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </span>
                    ...
                    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                        <div class="w-full bg-white rounded-lg shadow dark:border sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                                <h1 class="text-3xl font-extrabold text-orange-600 md:text-2xl dark:text-white text-center">
                                    Login-ID
                                </h1>
                                ...
                                <form method="POST" class="space-y-4 md:space-y-6" action="{{ route('loginWithId') }}">
                                    ...
                                    <div class="text-center mt-4">
                                        ...
                                        <p class="text-sm font-light text-gray-500 dark:text-gray-400 py-2">Login with Email</p>
                                    </div>
                                    ...
                                    <p class="text-center text-sm font-light text-gray-500 dark:text-gray-400">
                                        ...
                                        <a href="{{ route('register') }}"
                                           class="font-medium text-primary-900 hover:underline hover:text-orange-600 dark:text-primary-500">Sign Up here</a>
                                    </p>
                                </form>
                            </div>
                        </div>
