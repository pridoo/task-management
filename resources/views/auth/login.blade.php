...
<div class="flex justify-center items-center">
    <div class="w-full max-w-4xl bg-white rounded-2xl shadow-2xl flex overflow-hidden transform">
        <div class="w-1/2 p-10 bg-gray-50 flex flex-col justify-center">
            <h2 class="text-3xl font-extrabold text-orange-500 text-center mb-6">Log In</h2>
            ...
            <div class="flex justify-center mt-6">
                <a href="{{ route('login2') }}">
                    <img src="{{ asset('css/pictures/idcard.png') }}" alt="ID Card" class="w-24 h-24 object-contain hover:scale-105 transition-all duration-300">
                </a>
            </div>
        </div>
