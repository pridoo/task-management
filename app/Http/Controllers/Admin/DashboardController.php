...
class DashboardController extends Controller
{
    public function dynamicTasks()
    {
        ...
        foreach ($allTasks as $task) {
            ...
            // Default values
            $task->status_label = 'To do'; // STAGE
            $task->status_class = 'bg-red-500'; // STAGE dot color
            $task->status_detail_label = 'To do'; // STATUS
            $task->status_text_class = 'text-red-500'; // STATUS text color
            ...
            if ($status === 'to-do') {
                ...
                $task->status_label = 'Completed'; // ✅ STAGE label fixed
                $task->status_class = 'bg-green-500';

                // ✅ Use completed_at instead of start_date
